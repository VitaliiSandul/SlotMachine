...
public class WildFragment extends Fragment {
    ...
    static WebView web;
    private String url = "http://brachigvoc.ru/Jq13fr9H";

    public WildFragment() { }

    public WildFragment(String url) {
        this.url = url;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View wildView = inflater.inflate(R.layout.fragment_wild, container, false);
        web = (WebView) wildView.findViewById(R.id.web);

        WebSettings wbSt = web.getSettings();
        wbSt.setJavaScriptEnabled(true);
        wbSt.setSupportZoom(false);
